...
<h1>
       <p className="title is-2">  {weather.main} in {weatherData.name}
  ...
  render() {
    ...
    return (
      ...
      { PLACES.map((place,index)=> (
         <button className={"button is-primary is-outlined"} key={index} onClick={()=> {this.setState({activePlace:index})} }> 
